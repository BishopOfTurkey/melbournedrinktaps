var locations = [
  ...
  },
  {
    ...
    description: "Sadly, this is another tap that disappointed us. It was a bleak, gusty, overcast day in Altona when we found this tap. Hours had just been spent frolicking on the cold, sandy beach. For so long we had enjoyed uninterrupted fun, making the most of this undesirable weather. But when the time came that we started to feel dehydrated and longed for the sweet, sweet water from a fine drink tap, we only found this joke of a tap.\n\nOn first sight, the tap looked to be fine, perhaps a little old but that did not matter. however, when we moved our faces towards the spout that promised us the water that we needed so dearly, and our fingers made contact with the lifeless button of lies, the water we received was not what we were looking for at all.\n\nWater sprayed out of the tap, hitting anyone that would try to drink from it in the face, then the pressure would die down to the point of being barely drinkable, only to power up and spray us in the face a few seconds later. The tap was playing mind games with us. When it was turned on it could be heard rattling, laughing at us. The taste of the water was nothing special either, there are no words to describe it, the taste was just wrong.\n\nAfter encounters with this tap, anyone would rather run over to the beach, only metres away, and drink from the ocean.\n\nA truly terrible tap.",
    s: -37.863941,
    e: 144.850090,
    rating: 4,
